...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.updateLogHeader = undefined;
	
	var _jquery = __webpack_require__(/*! jquery */ 1);
	
	var _jquery2 = _interopRequireDefault(_jquery);
	
	var _storage = __webpack_require__(/*! ./storage.js */ 2);
	...
	function (request, sender, sendResponse) {
	  ...
	  if (request.message == "userinput") {
	    ...
	    (0, _storage.setChromeSync)({ "data": { "long": request.long, "lati": request.lati } });
	    return true;
	  }
	  if (request.message == "askForData") {
	    console.log("receive ask for data");
	    (0, _storage.getChromeSync)("data").then(function (data) {
	      sendResponse(data);
	    });
	    return true;
	  }
	...
	exports.updateLogHeader = updateLogHeader;
...
/***/ (function(module, exports) {
	...
	exports.getChromeSync = getChromeSync;
	exports.setChromeSync = setChromeSync;
